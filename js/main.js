const SPEC = {
  "slug": "habit-tide",
  "title": "Habit Tide",
  "description": "Ride the habits that compound and notice when the tide is pulling back.",
  "lede": "Track habits with cues, reset plans, and check-in dates so consistency is visible before it slips.",
  "heroEyebrow": "Habit rhythm workspace",
  "boardTitle": "Habit tide board",
  "boardSubtitle": "A local-first board for riding the habits that compound and rescuing the ones that slip.",
  "accent": "Cues, resets, and check-ins make habits easier to sustain than vague motivation ever will.",
  "itemLabel": "habit",
  "itemPluralLabel": "Habits",
  "labels": {
    "title": "Habit",
    "note": "Habit note",
    "category": "Habit type",
  ...
  "textOne": {
    "label": "Cue",
    "default": "What triggers this habit"
  },
  "textTwo": {
    "label": "Next reset",
    "default": "How you rescue it if it slips"
  },
  "date": {
    "label": "Next check-in"
  },
  ...
  "defaults": {
    "note": "Describe what makes this habit compound when life gets noisy."
  },
  "stats": {
    "totalLabel": "Habits",
    "motionLabel": "Riding",
    "dueLabel": "Check-ins soon"
  },
  "insights": {
    "topLabel": "Strongest habit",
    "dateLabel": "Next habit check-in",
    "metricLabel": "Best consistency"
  },
  "queue": {
    "eyebrow": "Habit queue",
    "title": "What needs attention next",
    "empty": "Archived habits stay out of the active tide."
  },
  "mix": {
    "eyebrow": "Habit mix",
    "title": "Where your rhythm sits"
  },
  "emptyTitle": "No habits yet",
  "emptyBody": "Add the habits, cues, and resets that shape your week.",
  "actions": [
    {
      "id": "log",
      "label": "Log today",
      ...
      "fromToday": true,
      "metricDelta": 1,
      "toast": "Logged this habit for today."
    },
    {
      "id": "rescue",
      "label": "Run reset",
      ...
      "fromToday": true,
      "effortDelta": -1,
      "toast": "Used the reset plan and pulled this habit back."
    },
    {
      "id": "mark-slip",
      "label": "Mark slipping",
      ...
      "fromToday": true,
      "metricDelta": -1,
      "toast": "Marked this habit as slipping."
    }
  ],
  "theme": {
    "primary": "#2dd4bf",
  ...
  "items": [
    {
      ...
      "metric": 8,
      "textOne": "After tea",
      "textTwo": "Reset with 5-minute list trim",
      "date": "2026-04-25",
      "note": "This habit keeps the day coherent before chat noise takes over."
    },
    {
      "title": "Walk after long coding block",
      "category": "Health",
      "state": "Planned",
      "score": 7,
      "effort": 4,
      "metric": 5,
      "textOne": "After 90 minutes focused",
      "textTwo": "Do one short lap, not a full workout",
      "date": "2026-04-26",
      "note": "The smaller the reset step, the easier it is to actually do."
    },
    {
      ...
      "effort": 5,
      "metric": 4,
      "textOne": "After shutdown",
      "textTwo": "Shrink to 10 minutes and one note",
      "date": "2026-04-25",
      "note": "Still valuable, but it needs a lower-friction rescue plan."
    }
  ]
};
