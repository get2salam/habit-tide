  ...
  "slug": "habit-tide",
  "title": "Habit Tide",
  "tagline": "Ride the habits that compound and notice when the tide is pulling back.",
  "domainLabel": "habits",
  "itemLabel": "habit",
  "emptyTitle": "No habits yet",
  "emptyBody": "Track the habits worth protecting when work gets intense.",
  "seedTitle": "Habit tide board",
  "seedSubtitle": "A low-friction place to watch habits rise, stall, or recover.",
  "categories": [
    "Mind",
    "Body",
    "Work",
  ...
  "items": [
    {
      "title": "Nightly shutdown note",
      "category": "Work",
      "state": "Stable",
      "score": 8,
      "effort": 1,
      "note": "Write tomorrow's first task before closing the laptop."
    },
    {
      "title": "Daily walk reset",
      "category": "Body",
      "state": "Slipping",
      "score": 7,
      "effort": 2,
      "note": "The habit is tiny, but the mood and focus impact is outsized."
    },
    {
      ...
      "score": 6,
      "effort": 1,
      "note": "Keep it brutally simple so it survives long days."
    }
  ]
};
